// KCY1 Token (KCY-meme-1) v23 - Comprehensive Test Suite
...
describe("KCY1 Token v23 - Complete Test Suite", function() {
    let token;
    let owner;
    ...
    describe("1. Deployment & Initialization", function() {
        ...
        it("1.6 Should detect testnet deployment", async function() {
